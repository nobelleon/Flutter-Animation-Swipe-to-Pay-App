...
import 'package:swipe_to_pay/widgets/animated_circular_progress_bar.dart';
import 'package:swipe_to_pay/widgets/loading_animation.dart';
import 'package:swipe_to_pay/widgets/payment_icon_widget.dart';
import 'package:swipe_to_pay/widgets/pin_input_widget.dart';

import 'animated_slider/widgets/slider_text_widget.dart';
              ...
              builder: (context, child) {
                return Column(
                  children: [
                    ...
                    //------------------------
                    // Keypad & Slider Button
                    //------------------------
                    _buildSegmentedButton(),
                    const SizedBox(height: 20),
                    //-----------------------------------
                    // Enter Amount (Number) & KeyPad
                    //-----------------------------------
                    Expanded(
